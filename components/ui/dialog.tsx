  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile optimizations - full screen on small devices
        "max-sm:h-full max-sm:w-full max-sm:max-w-none max-sm:rounded-none max-sm:translate-x-0 max-sm:translate-y-0 max-sm:left-0 max-sm:top-0",
        className,
      )}
      {...props}
    >
